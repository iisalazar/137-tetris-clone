...
// // address
// try {
// // address = InetAddress.getByName("localhost"); // todo: change later to ip
// of player1
...
// // if a codeword is found, that means it is a new player and would be added
// to the players list.
// if (stringMessage.contains("init;")) {
...
// DatagramPacket sendPacket = new DatagramPacket(byteMessage,
// byteMessage.length, address, other_port); // todo: add option for different
// ip
// try {
// socket.send(sendPacket);
// } catch (Exception e) {
